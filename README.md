...
## Dataset
The raw dataset consists of CAISO historical hourly load Excel files. You can download these into `caiso_load_data/` using the integrated scraper or place them there manually.
...
* **Merge Data**: `load-forecast merge --input-dir caiso_load_data --output-file caiso_load_complete.csv`
* **Calendar Features**: `load-forecast calendar --input-file caiso_load_complete.csv --output-file caiso_features.csv`
* **Lag Features**: `load-forecast lags --input-file caiso_features.csv --output-file caiso_model_ready.csv`
* **Weather (Optional)**: `load-forecast weather --input-file caiso_model_ready.csv --output-file caiso_final_dataset.csv`
* **Train Model**: `load-forecast train --input-file caiso_model_ready.csv --plot-file forecast_check.png`
